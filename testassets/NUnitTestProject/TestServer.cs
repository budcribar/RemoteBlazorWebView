...
namespace WebdriverTestProject
{
    ...
    public class TestServerWpf : TestRemoteBlazorWpf
    {
        ...
        protected override async Task TestClient(int num)
        {
            ...
            Assert.AreEqual(594072 * num, totalBytesRead, "Failed on total bytes read");
    ...
    public class TestServerForm : TestRemoteBlazorForm
    {
        ...
        protected override async Task TestClient(int num)
        {
            ...
            Assert.AreEqual(12 * num, totalFilesRead, "Failed on total files read");  
            Assert.AreEqual(593992 * num, totalBytesRead, "Failed on total bytes read"); // This will vary depending on the size of the Javascript  
            Console.WriteLine($"TotalBytesRead {totalBytesRead}");
            Console.WriteLine($"TotalReadTime {totalReadTime}");
