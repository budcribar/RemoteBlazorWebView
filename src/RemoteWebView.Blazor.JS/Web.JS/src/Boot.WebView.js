        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    started = true;
                    exports.dispatcher = dotnet_js_interop_1.DotNet.attachDispatcher({
...
function receiveWebViewDotNetDataStream(streamId, data, bytesRead, errorMessage) {
    (0, StreamingInterop_1.receiveDotNetDataStream)(exports.dispatcher, streamId, data, bytesRead, errorMessage);
}
