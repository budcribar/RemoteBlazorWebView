...
namespace HelloRemotePhotino.Blazor
{
    public class Program
    {
        ...
        static void Main(string[] _)
        {
            ...
            var pw = new RemoteBlazorWebWindow(new Uri("https://localhost:443"), "wwwroot/index.html", "Hello Remote Photino Blazor!", default, (o) => { o.WebMessageReceivedHandler = (s, e) => { Console.WriteLine($"Web Message {e}"); }; });
