...
namespace PeakSWC.RemoteBlazorWebView.Windows
{
    internal class IPC
    {
        ...
        private readonly IBlazorWebWindowBase _photinoWindow;

        public IPC(IBlazorWebWindowBase photinoWindow)
        {
        ...
        public void Send(string eventName, params object?[] args)
        {
            try
            {
                var pd = _photinoWindow.PlatformDispatcher as DesktopDispatcher;
                pd?.InvokeAsync(() =>
                {
