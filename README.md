...
RemoteBlazorWebView.Wpf.BlazorWebView is based on the .NET 6 Preview 6 Blazor WebView Control for WPF
...
RemoteBlazorWebView.WindowsForms.BlazorWebView is based on the .NET 6 Preview 6 Blazor WebView WinForms Control 
